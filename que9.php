...
?>
 ...
 <body>
 	<div id="frame" style="width: 75%; margin: 0 auto;">
 		<form action="que9.php" method="post">
 			<div id= "question">
 				<?php 
 				$i =9;
 		...
 		<div>
 			...
 			<img src="img/9A.png" height="250" style="margin:0px 50px">
 			<img src="img/9B.png" height="250" style="margin:0px 50px">
 			<img src="img/9C.png" height="250" style="margin:0px 50px">
 			<img src="img/9D.png" height="250" style="margin:0px 50px"></br></br>
