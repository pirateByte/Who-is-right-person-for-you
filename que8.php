...
?>
 ...
 <body>
 	<div id="frame" style="width: 75%; margin: 0 auto;">
 		<form action="que8.php" method="post">
 			<div id= "question">
 				<?php 
 				$i =8;
 		...
 		<div>
 			...
 			<img src="img/8A.png" height="250" style="margin:0px 50px">
 			<img src="img/8B.png" height="250" style="margin:0px 50px">
 			<img src="img/8C.png" height="250" style="margin:0px 50px">
 			<img src="img/8D.png" height="250" style="margin:0px 50px"></br></br>
