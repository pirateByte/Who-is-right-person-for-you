...
?>
 ...
 <body>
 	<div id="frame" style="width: 75%; margin: 0 auto;">
 		<form action="que7.php" method="post">
 			<div id= "question">
 				<?php 
 				$i =7;
 		...
 		<div>
 			...
 			<img src="img/7A.png" height="250" style="margin:0px 50px">
 			<img src="img/7B.png" height="250" style="margin:0px 50px">
 			<img src="img/7C.png" height="250" style="margin:0px 50px">
 			<img src="img/7D.png" height="250" style="margin:0px 50px"></br></br>
