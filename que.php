 ...
 <body>
 	<div id="frame" style="width: 75%; margin: 0 auto;">
 		...
 		<div>
 			...
 			<img src="img/1A.png" height="250" style="margin:0px 50px">
 			<img src="img/1B.png" height="250" style="margin:0px 50px">
 			<img src="img/1C.png" height="250" style="margin:0px 50px">
 			<img src="img/1D.png" height="250" style="margin:0px 50px"></br></br>
 			<input type="radio" name="ans" value="A" style="margin:0px 127px">
 			<input type="radio" name="ans" value="B" style="margin:0px 127px">
 			<input type="radio" name="ans" value="C" style="margin:0px 127px">
 			<input type="radio" name="ans" value="D" style="margin:0px 127px"></br></br>
