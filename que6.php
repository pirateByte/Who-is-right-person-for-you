...
?>
 ...
 <body>
 	<div id="frame" style="width: 75%; margin: 0 auto;">
 		<form action="que6.php" method="post">
 			<div id= "question">
 				<?php 
 				$i =6;
 		...
 		<div>
 			...
 			<img src="img/6A.png" height="250" style="margin:0px 50px">
 			<img src="img/6B.png" height="250" style="margin:0px 50px">
 			<img src="img/6C.png" height="250" style="margin:0px 50px">
 			<img src="img/6D.png" height="250" style="margin:0px 50px"></br></br>
 			<input type="radio" name="ans" value="A" style="margin:0px 120px">
 			<input type="radio" name="ans" value="B" style="margin:0px 120px">
 			<input type="radio" name="ans" value="C" style="margin:0px 120px">
 			<input type="radio" name="ans" value="D" style="margin:0px 120px"></br></br>
