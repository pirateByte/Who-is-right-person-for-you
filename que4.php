 ...
 <body>
 	<div id="frame" style="width: 75%; margin: 0 auto;">
 		...
 		<div>
 			...
 			<img src="img/4A.png" height="250" style="margin:0px 50px">
 			<img src="img/4B.png" height="250" style="margin:0px 50px">
 			<img src="img/4C.png" height="250" style="margin:0px 50px">
 			<img src="img/4D.png" height="250" style="margin:0px 50px"></br></br>
 			<input type="radio" name="ans" value="A" style="margin:0px 120px">
 			<input type="radio" name="ans" value="B" style="margin:0px 112px">
 			<input type="radio" name="ans" value="C" style="margin:0px 112px">
 			<input type="radio" name="ans" value="D" style="margin:0px 124px"></br></br>
